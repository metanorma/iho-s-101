...
The hierarchy of metadata provided in <<AnnexA,clause="3.3",table="3-1">>
...
<<AnnexA>>, must be populated where
applicable.
...
metadata features and attributes as described in <<AnnexA>>, should be populated to
...
described in <<AnnexA>>. IHO Publications S-158:100
- _S-100 Validation Checks_ and/or S-158:101 - _S-101 Validation Checks_,
provide validation checks which verify this conformance.
...
attributes must conform to the S-101 Feature Catalogue and the rules
described in <<AnnexA>>. Relevant metadata features
