...
The hierarchy of metadata provided in <<S101AnnexA,table="3-1">>
...
from <<IHO_S_100,part=5>>.

Data Producers must verify that the dataset conforms to the S-101
Feature Catalogue and rules described in <<S101AnnexA>>. IHO Publications S-158:100
...
from <<IHO_S_100,part=10a>>.

Data Producers must verify that the dataset conforms to S-101 Annex B
...
relevant metadata features and attributes as described in
<<S101AnnexA>>, must be populated where
applicable.
...
guidelines from <<IHO_S_100,part=4c>>.
...
metadata features and attributes as described in <<S101AnnexA>>, should be populated to
...
to the S-101 Feature Catalogue and the rules described in
<<S101AnnexA>>. IHO Publications
S-158:100 - _S-100 Validation Checks_ and/or S-158:101 -
_S-101 Validation Checks_, provide validation checks which verify
this conformance.
...
described in <<S101AnnexA>>. IHO Publications S-158:100
- _S-100 Validation Checks_ and/or S-158:101 - _S-101 Validation Checks_,
provide validation checks which verify this conformance.
...
attributes must conform to the S-101 Feature Catalogue and the rules
described in <<S101AnnexA>>. Relevant metadata features
...
S-101 datasets must conform to all mandatory elements of <<S101AnnexA>>,
