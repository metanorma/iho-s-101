...
S-101 conforms to the General Feature Model (GFM) from <<IHO_S_100,part=3>>.
The GFM is the conceptual model and the implementation is
...
from the IHO website.
<<S101AnnexA>> constitutes a human readable interpretation of the Feature
Catalogue.

[[sec_4.3.2]]
==== Feature types

Details of feature types can be found in
<<S101AnnexA,clause=2.1>> and <<S101AnnexA,section=3>> - <<S101AnnexA,section=23>>.
...
Details of geographic feature types can be found in
<<S101AnnexA,clause=2.1>> and
<<S101AnnexA,section=4>> - <<S101AnnexA,section=22>>.

[[sec_4.3.2.1.1]]
====== Skin of the Earth

Details of features comprising the Skin of the Earth can be found
in <<S101AnnexA,clause=2.5.1.1>>.

[[sec_4.3.2.2]]
===== Metadata features

Details of metadata feature types can be found in
<<S101AnnexA,clause=2.1>> and <<S101AnnexA,section=3>>.

[[sec_4.3.2.3]]
===== Cartographic

Details of cartographic feature types can be found in
<<S101AnnexA,clause=2.1>> and <<S101AnnexA,section=23>>.
...
Details of information types can be found in
<<S101AnnexA,clause=2.3>>, <<S101AnnexA,clause=2.4.7>> and
<<S101AnnexA,section=24>>.

[[sec_4.3.4.1]]
===== Spatial quality

Spatial quality attributes are carried in an information class called
*Spatial Quality*. Details of spatial quality can be found in
<<S101AnnexA,clause=2.4.7>> and <<S101AnnexA,clause=24.5>>.
...
in <<S101AnnexA,clause=2.4.2>>.
Descriptions of the simple attributes included in S-101 can be found
in <<S101AnnexA,section=27>>, <<S101AnnexA,section=28>> and <<S101AnnexA,section=30>>.
...
<<IHO_S_100,locality:appendix=2a-A>>. Descriptions of the complex attributes
included in S-101 can be found in <<S101AnnexA,section=29>>.
...
(see <<IHO_S_100,locality:appendix=5-A,table=5-A-16>> and <<IHO_S_100,locality:appendix=5-A,table=5-A-21>>).
...
A dataset must not cross the stem:[180 "unitsml(deg)"] meridian.
...
.. The **drawing index**es* footnote:[The attribute *drawing index* is required
where the datasets intended to form a seamless presentation in ECDIS do not
share a common minimum display scale. The attribute *drawing index* is also
required if the dataset may need to form a seamless presentation with one or
more S-57 datasets, in which case the value should correspond to the usage band
of the adjoining or overlapping S-57 dataset(s). See <<AnnexA,clause=3.5>>
and <<AnnexA,clause=28.3>>.], where populated,
must be the same.
...
band of the adjoining or overlapping S-57 dataset(s). See <<S101AnnexA,clause=3.5>>
and <<S101AnnexA,clause=28.3>>.
...
as defined by <<IHO_S_100,part=7>>.
