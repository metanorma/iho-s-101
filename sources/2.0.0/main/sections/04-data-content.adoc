...
<<AnnexA>> constitutes a human readable interpretation of the Feature
Catalogue.
...
<<AnnexA,clause=2.1>> and <<AnnexA,section=3>>-<<AnnexA,section=23>>.
...
<<AnnexA,clause=2.3>>, <<AnnexA,clause=2.4.7>> and
<<AnnexA,section=24>>.
...
<<AnnexA,clause=2.4.7>> and <<AnnexA,clause=24.5>>.
...
in <<AnnexA,clause=2.4.2>>.
Descriptions of the simple attributes included in S-101 can be found
in <<AnnexA,section=27>>, <<AnnexA,section=28>> and <<AnnexA,section=30>>.
...
<<IHO_S_100,part=2a,locality:appendix=2a-A>>. Descriptions of the complex attributes
included in S-101 can be found in <<AnnexA,section=29>>.
...
(see <<IHO_S_100,part=5,locality:appendix=5-A,table=5-A-16>> and <<IHO_S_100,part=5,locality:appendix=5-A,table=5-A-21>>).
