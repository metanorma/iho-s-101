...
*Vertical Datum of Data*. See <<S101AnnexA,clause=3.9>> and <<S101AnnexA,clause=3.10>>.
...
see <<S101AnnexA,clause=3.9>>), where the depth information is stored in the Z-coordinate.
...
feature *Sounding Datum* (see <<S101AnnexA,clause=3.9>>).
