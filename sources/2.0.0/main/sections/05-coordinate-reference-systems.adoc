...
*Vertical Datum of Data*. See <<AnnexA,clause=3.9>> and <<AnnexA,clause=3.10>>.
...
see <<AnnexA,clause=3.9>>), where the depth information is stored in the Z-coordinate.
...
feature *Sounding Datum* (see <<AnnexA,clause=3.9>>).
