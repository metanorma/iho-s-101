...
The S-100 Exchange Set structure is described in
<<IHO_S_100,part=17,clause=17-4.1>>.
...
(S100_ResourcePurpose (ISOMetadata) - see <<IHO_S_100,part=17,clause=17-4.5>>)
...
described in <<IHO_S_100,part=17,clause=17-4.1>>.
...
files. See <<IHO_S_100,part=17,clause=17-4.4>> and <<IHO_S_100,part=17,clause=17-4.5>>.
--
...
named "CATALOGUES". Refer to <<IHO_S_100,clause=17-4.2,figure=17-3>>.
...
(see <<IHO_S_100,part=17,clause=17-4.3.1>>).
...
See <<IHO_S_100,part=15>> and <<IHO_S_100,part=17>>.
