...
* Inactive submarine volcanos must be encoded, if required, as *Sea Area* with stem:[bb "category of sea area" = 56] (submarine volcano). Active submarine volcanos must be encoded, if required, using an *Obstruction* feature (see <<sec_13.6>>).
