...
done using a *Building* feature, with attributes
stem:[bb "function" = 15] (transit shed/warehouse), and if it is required,
*feature name* (*name*) = name or number of the shed.
