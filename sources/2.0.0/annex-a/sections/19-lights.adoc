...
a sector boundary occurs over an angle of less than 1 minute (stem:[0*02"unitsml(deg)"]).
This corresponds to a lateral distance of just 1 metre at a viewing
distance of stem:[3.5 "unitsml(km)"]. In addition the intensity may be maintained right
...
(normally up to stem:[2 "unitsml(km)"]) type of directional "light". Sodium lighting
gives a yellow background to a screen (up to stem:[3 "unitsml(m)"] square) on which a
