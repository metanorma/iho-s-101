...
stem:[bb "topmark shape" = 8] (upright cross) and
stem:[bb "colour" = 6] (yellow).
...
stem:[bb "colour" = 5,6] (blue, yellow),
stem:[bb "light characteristic" = 17]
(occulting alternating), *signal group* = _(1)_
...
3+| visitors mooring 2+| _(SMCFAC)_ 3+| | BO | 0,1
...
3+| horizontal length 2+| (HORLEN) 3+| | RE | 0,1

3+| horizontal width 2+| (HORWID) 3+| | RE | 0,1
...
3+| signal frequency 2+| (SIGFRQ) 3+| | IN | 0,1
...
3+| signal period 2+| (SIGPER) 3+| | RE | 0,1
