...
9+.<| footnote:crossnote[] Complex attribute **feature name**, sub-attribute *name usage* is mandatory if the name is intended to be displayed when display of names is enabled by the Mariner. See <<sec_2.5.8>>.
...
[[fig_11-2]]
.Depth contours
image::figure-11-1.png[Shape25,286,459]
...
[[fig_11-3]]
.Geometry of depth areas
image::figure-11-3.png[Shape26,545,204]
...
[[fig_11-4]]
.Depth areas
image::figure-11-4.png[Shape27,454,442]
