...
| *Airport/Airfield*, *Anchor Berth*, *Anchorage Area*, *…* | 0,*

h| Role Type h| Role h| Associated With h| Multiplicity
.2+| Association | The Information | *Contact Details*, *Nautical Information* | 0,1
| | *Administration Area*, **…**, *Wind Turbine* | 0,*

h| Role Type h| Role h| Associated With h| Multiplicity
.2+| Association | The Information | *Nautical Information* | 0,1
| | …, *Two-Way Route*, *Two-Way Route Part*, *Underwater/Awash Rock*, *…* | 0,*
|===
...
features.
* A *Two-Way Route Part* instance is _the component_ (or is a
...
h| S-101 Role footnoteblock:[footnote_25_6_4]
h| Association Type footnoteblock:[footnote_25_6_1]
h| Associated to footnoteblock:[footnote_25_6_2]
h| Type footnoteblock:[footnote_25_6_3]
h| Multiplicity footnoteblock:[footnote_25_6_5]
...
NOTE: Each row included in <<table_25-6>> above describes a S-101
...
they would appear at the end of the association containing
*Lateral Buoy* (see <<fig_25-1>> and associated guidance).
...
described in <<IHO_S_100,part=1,clause=1-4.9>>; and included in the tables
...
* 0,1 for the *Structure/Equipment* association means that a
*Lateral Buoy* can exist in isolation (lower multiplicity 0) but, if the
...
h| Role Type h| Role h| Associated With h| Multiplicity
.2+| Association
| The Information | *Contact Details*, *Non-Standard Working Day*, *Service Hours*,
*Nautical Information* | 0,1
