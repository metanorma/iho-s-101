...
. Where a *Seabed Area* feature of type surface is located in an intertidal area, it should be encoded with stem:[bb "water level effect" = 4] (covers and uncovers), in order for the intertidal rock or coral symbol to be displayed in ECDIS.
--
