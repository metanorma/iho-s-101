...
stem:[bb "nature of surface" = 14] (coral) and
stem:[bb "water level effect" = 3]
(always underwater/submerged). This feature must be
...
intertidal area, it should be encoded with
stem:[bb "water level effect" = 4]
(covers and uncovers), in order for the intertidal rock
