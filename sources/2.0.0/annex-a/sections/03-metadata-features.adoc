...
3+| maximum display scale 2+| 3+| maximum display scale ≤ optimum display scale < minimum display scale | IN | 1,1 3+| minimum display scale 2+| 3+| See <<table_3-2>> belowminimum display scale > optimum display scale ≥ maximum display scale | IN
| 1,1

3+| optimum display scale 2+| _(CSCALE)_ 3+| See <<table_3-2>> belowmaximum display scale ≤ optimum display scale < minimum display scale | IN | 1,1 3+| information 2+| 3+| See <<sec_2.4.6>> | C
| 0,*
