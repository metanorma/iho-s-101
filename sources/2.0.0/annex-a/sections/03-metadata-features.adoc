...
on individual features. In a Base dataset (see <<S101,annex=B,clause=B5>>),
...
3+| maximum display scale 2+| 3+| maximum display scale stem:[<=] optimum display scale < minimum display scale | IN | 1,1 3+| minimum display scale 2+| 3+| See <<table_3-2>> below minimum display scale > optimum display scale stem:[>=] maximum display scale | IN
| 1,1
...
mandatory attributes stem:[bb "data assessment" = 1] (assessed)
stem:[bb "category of temporal variation" = 6] (unassessed); *features detected*
