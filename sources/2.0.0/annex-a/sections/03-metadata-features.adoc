...
3+| survey date range 2+| 3+| See clause 2.4.8 | C | 0,1
...
3+| MRN (see clause 27.114) | URN | 0,1
...
Distinction: Accuracy of Data; Quality of Bathymetric Data.
...
3+| scale minimum 3+| (SCAMIN) 3+| See clause 2.5.9 | IN | 0,1 footnote:crossnote[]
3+| source
3+| 3+|
