...
[underline]#Range closure:# Closed interval (stem:["minimum" <= bb "stream depth" <= "maximum"])
...
[underline]#Range closure:# Open interval (stem:["minimum" < bb "value of sounding" < "maximum"])
