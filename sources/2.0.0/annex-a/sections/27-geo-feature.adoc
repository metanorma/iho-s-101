...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "buried depth" <= "maximum"])
...
2+| Depth Accuracy
footnote:[Depth accuracy of depicted soundings
stem:[= a + (b ** d)//100] at 95% CI (2.00 sigma),
where stem:[d = "depth"] in metres at the
...
(stem:["minimum" < bb "depth range maximum" < "maximum"])
...
[underline]#Range closure:# Open interval
(stem:["minimum" < bb "depth range minimum" < "maximum"])
...
(stem:["minimum" <= bb "elevation" <= "maximum"])
...
[underline]#Range closure:# Open interval
(stem:["minimum" < bb "estimated range of transmission" < "maximum"])
...
[underline]#Format:# *101CCCCØØØØØØØØØØ.EEE* (See
<<S101,clause=11.4.3>> (mandatory))
...
(stem:["minimum" <= bb "flare bearing" < "maximum"])
...
reciprocal (+/- stem:[180 "unitsml(deg)"] of the bearing encoded for the navigational
line); or to avoid other important encoded information.
* The default bearing of a light flare (stem:[135 "unitsml(deg)"]) is provided as a
...
bearing of stem:[45 "unitsml(deg)"], also as a function of the S-101 Portrayal Catalogue,
as follows:

** If one of the lights is a white, yellow or orange light, it is
displayed at a bearing of stem:[45 "unitsml(deg)"].
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "height" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "ice factor" <= "maximum"])
...
* For further information regarding MRNs, see <<IHO_S_100,part=3,clause=3-10>>.
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "magnetic anomaly value" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "maximum permitted draught" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "minimum berth depth" <= "maximum"])
...
(stem:["minimum" <= bb "number of features"])
...
[underline]#Precision:# stem:[0&#x2219;01"unitsml(deg)"]
...
[underline]#Range closure:# Right half-open interval
(stem:["minimum" <= bb "orientation value" < "maximum"])
...
* An orientation quoted as stem:[360 "unitsml(deg)"] must be encoded as _0_.
...
EEE* (See <<S101,clause=11.4.3>> (mandatory))
...
[underline]#Range closure:# Closed interval
(stem:["minimum" <= bb"scale minimum" <= "maximum"])
...
[underline]#Range closure:# Right half-open interval
(stem:["minimum" <= bb "sector bearing" < "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "signal duration" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "signal period" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "speed limit" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "speed maximum" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "speed minimum" <= "maximum"])
...
[underline]#Range closure:# Closed interval
(stem:["minimum" <= bb "stream depth" <= "maximum"])
...
[underline]#Range closure:# Right half-open interval
(stem:["minimum" <= bb "text offset bearing" < "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "text offset distance" <= "maximum"])
...
[underline]#Range closure:# Closed interval
(stem:["minimum" <= bb "tide relative to tide" <= "maximum"])
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "underlying layer" <= "maximum"])
...
[underline]#Range closure:# Open interval
(stem:["minimum" < bb "value of depth contour" < "maximum"])
...
[underline]#Unit:# degree (stem:["unitsml(deg)"]), negative west
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "value of magnetic variation" <= "maximum"])

[underline]#Example:# *2.3* for a magnetic north oriented at 2.3
degrees (stem:[2"unitsml(deg)"18"unitsml(')"]) east from the geographic (true) north-*1.5* for a
magnetic north oriented at 2.3 degrees (stem:[1"unitsml(deg)"30"unitsml(')"]) west from the
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "value of nominal range" <= "maximum"])
...
[underline]#Range closure:# Open interval
(stem:["minimum" < bb "value of sounding" < "maximum"])
...
<<sec_2.4.6>>).
* The stem:[pm 0.3 "unitsml(m)"] approximation quoted in the
"approximate" levels is arbitrary and follows the British example
of their definition for "approximate LAT".
...
[underline]#Range closure:# Left half-open interval
(stem:["minimum" < bb "vertical length" <= "maximum"])Minimum value: 0
