...
13: west +
| (S) EN
| 0,1 footnote:crossnote[The sub-attribute *name usage* may be mandatory for certain encoding combinations for instances of complex attribute *feature name*. See clause 2.5.8.]
