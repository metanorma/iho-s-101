...
exceed stem:[3 "unitsml(deg)"] from the norm for the area (see <<sec_4.1>>), because diurnal
and seasonal fluctuations in the Earth's magnetic field can change
the stated variation by up to stem:[1 "unitsml(deg)"] and, in some parts of the world,
