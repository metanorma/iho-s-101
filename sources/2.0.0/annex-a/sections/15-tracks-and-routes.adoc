...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnote:fifteen_four[For each instance of *fixed date range*, at least one of the sub-attributes *date end* or *date start* must be populated.
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[fifteen_twelve]
...
2: alternate name display +
| (S) EN
| 0,1 footnoteblock:[fifteen_fourteen]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[fifteen_sixteen]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[fifteen_eighteen]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[fifteen_nineteen]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[fifteen_twenty]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[fifteen_twentyone]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[fifteen_twentytwo]
...
2+| _(TXTDSC) (NTXTDS)_
3+| | (S) TE
| 0,1 footnote:fifteen_thirtyone[]
