...
It is important when encoding foul ground to be aware of the distinction between foul ground and the feature *Obstruction*, attribute *category of obstruction* = _6_ (foul area):
