...
3+| maximum permitted draught 2+| _(INFORM)__(NINFOM)_ 3+| | RE | 0,1

3+| maximum permitted vessel length 2+| _(INFORM)__(NINFOM)_ 3+| | RE | 0,1
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[sixteen_eight]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[sixteen_eleven]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[sixteen_thirteen]
...
2+| _(TXTDSC) (NTXTDS)_
3+| | (S) TE
| 0,1 footnote:sixteen_fifteen[For each instance of *information*, at least one of the sub-attributes *file reference* or *text* must be populated.]
...
2+| _(TXTDSC) (NTXTDS)_
3+| | (S) TE
| 0,1 footnote:sixteen_sixteen[For each instance of *information*, at least one of the sub-attributes *file reference* or *text* must be populated.]
...
3+| language 2+| 3+| ISO 639-2/T
| (S) TE
| 1,1 footnoteblock:[sixteen_twentytwo]
...
2+| _(TXTDSC) (NTXTDS)_
3+| | (S) TE
| 0,1 footnote:sixteen_twentythree[For each instance of *information*, at least one of the sub-attributes *file reference* or *text* must be populated.]
...
2+| _(INFORM) (NINFOM)_
3+| | (S) TE
| 0,1 footnote:sixteen_twentythree[]
...
2+| _(TXTDSC) (NTXTDS)_
3+| | (S) TE
| 0,1 footnote:sixteen_twentyfour[For each instance of *information*, at least one of the sub-attributes *file reference* or *text* must be populated.]
...
2+| _(INFORM) (NINFOM)_
3+| | (S) TE
| 0,1 footnote:sixteen_twentyfour[]
...
2+| (SIGGRP)
3+| | (S) TE
| 0,\* (ordered) footnoteblock:[nineteen_two]
...
[NOTE]
--
For non-fixed lights (that is, sub-attribute *light characteristic* ≠ _1_ (fixed)), the sub-attributes *signal group* and *signal period* are mandatory.
...
2+| (SIGGRP)
3+| | (S) TE
| 0,\* (ordered) footnoteblock:[nineteen_three]
...
2+| (SIGGRP)
3+| | (S) TE
| 0,\* (ordered) footnoteblock:[nineteen_four]
...
2+| (SIGGRP)
3+| | (S) TE
| 0,\* (ordered) footnoteblock:[nineteen_five]
...
3+| topmark
2+| __(___*TOPMAR*___)__ 3+| | C | 0,1
...
2+| _(INFORM)__(NINFOM)_ 3+| | RE | 0,1
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[twenty_seventeen]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[twenty_eighteen]
...
3+| MMSI code 2+| 3+| Unique 9 digit code
| TE
| 0,1
...
3+| sector bearing 2+| 3+| *sector limit one/sector bearing* ≠ *sector limit two/sector bearing* (_0_ = _360_)
| (S) RE
| 1,1
...
3+| sector bearing 2+| 3+| *sector limit two/sector bearing* ≠ *sector limit one/sector bearing* (_0_ = _360_)
| (S) RE
| 1,1
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnote:twentyfour_one[For each instance of *fixed date range*, at least one of the sub-attributes *date end* or *date start* must be populated.
]

3+| date start
2+| (DATSTA)
3+| | (S) TD
| 0,1 footnote:twentyfour_one[]
...
3+| linkage 2+| 3+| ISO 19115:2014
| (S) URI
| 1,1

3+| name of resource 2+| 3+| ISO 19115:2014
| (S) TE
| 0,1
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[twentyfour_two]
...
3+| time of day end
2+| 3+| | (S) TI
| 0,\* (ordered) footnoteblock:[twentyfour_two]
...
3+h| S-101 Attribute 2+h| S-57 Acronym 3+h| Allowable Encoding Value h| Type h| Multiplicity
3+| date fixed 2+| 3+| See <<sec_2.4.8>>
| TD
| 0,\* footnoteblock:[twentyfour_three]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[twentyfour_three]
...
2+| (DATEND)
3+| | (S) TD
| 0,1 footnoteblock:[twentyfour_four]
...
3+| fixed date range 2+| 3+| See <<sec_2.4.8>>
| (S) C
| 0,1 footnoteblock:[twentyfour_five]
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*buried depth*_ _≤ maximum_)
...
[underline]#Example:# *[VHF0007]* for VHF-Channel 7**[NBDP5555]** for Narrow Band Direct Printing Channel 5555
...
[underline]#Format:# YYYYMMDD (full date, *mandatory*)YYYYMM-- (no specific day required -- *mandatory*)YYYY---- (no specific month required -- *mandatory*)
...
[underline]#Format:# YYYYMMDD (full date, *mandatory*)YYYYMM-- (no specific day required -- *mandatory*)YYYY---- (no specific month required -- *mandatory*)----MMDD (same day each year, *mandatory*)----MM--(same month each year, *mandatory*)

[underline]#Example:# *20101203* for 03 December 2010 at 240000 hours as ending date.*----02--* for 28 February at 240000 hours as ending date for non-leap years; and 29 February at 240000 hours as ending date for leap years.
...
[underline]#Format:# ----MMDD (same day each year, *mandatory*)----MM--(same month each year, *mandatory*)

[underline]#Example:# *----0908* for 08 September each year.*----02--* for February of each year.
...
[underline]#Example:# *20101129* for 29 November 2010 at 000000 hours as starting date.*----02--* for 01 February at 000000 hours annually as starting date.
...
[underline]#Range closure:# Open interval (_minimum <_ _*depth range maximum*_ _< maximum_)
...
[underline]#Range closure:# Open interval (_minimum <_ _*depth range minimum*_ _< maximum_)
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*elevation*_ _≤ maximum_)
...
[underline]#Range closure:# Open interval (_minimum <_ _*estimated range of transmission*_ _< maximum_)
...
[underline]#Range closure:# Right half-open interval (_minimum ≤_ _*flare bearing*_ _< maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*frequency shore station receives*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*frequency shore station transmits*_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*height*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*horizontal clearance length*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*horizontal clearance value*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*horizontal clearance width*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*horizontal length*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*horizontal width*_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*ice factor*_ _≤ maximum_)
...
[underline]#Format:# *urn:mrn:*_[Organisational ID]_*:*…*:*... (mandatory)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*lifting capacity*_)
...
[underline]#Format:# *http://*..... or *https://*..... (mandatory)Example:https://www.iho.int/[**https://www.iho.int**]
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*magnetic anomaly value*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*maximum permitted draught*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*maximum permitted vessel length*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*measured distance*_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*minimum berth depth*_ _≤ maximum_)
...
[underline]#Example:# *AU* for Australia**US** for the United States of America
...
[underline]#Range closure:# Left closed ray (_minimum ≤_ _*number of features*_)
...
[underline]#Range closure:# Right half-open interval (_minimum ≤_ _*orientation value*_ _< maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*radius*_)
...
[underline]#Format:# YYYY----

[underline]#Example:# **2009----**
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*scale minimum*_ _≤ maximum_)Example: If a particular minimum scale is specified as 1:89 999 (encoded as *89999*), and an example of a smaller scale would be 1:179 999 (encoded as *179999*).
...
[underline]#Range closure:# Right half-open interval (_minimum ≤_ _*sector bearing*_ _< maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*sector line length*_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*signal duration*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*signal frequency*_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*signal period*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*speed limit*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*speed maximum*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*speed minimum*_ _≤ maximum_)
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*stream depth*_ _≤ maximum_)Examples:*0* for surface tidal stream data**15** for tidal stream data collected at a depth of 15 metres
...
[underline]#Range closure:# Right half-open interval (_minimum ≤_ _*text offset bearing*_ _< maximum_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*text offset distance*_ _≤ maximum_)
...
[underline]#Format:# hhmmssZ *(mandatory* for UTC time**)**hhmmss+hhmm *(mandatory* for local time with UTC offset**)**hhmmss *(mandatory* for local time without offset**)**

[underline]#Example:# *162000Z* for a period ending at 04:20 pm UTC.*162000+0100* for a period ending at 04:20 pm local time, 1 hour ahead of UTC.*162000* for a period ending at 04:20 pm local time, without specified offset to UTC.
...
[underline]#Example:# *094500Z* for a period starting at 09:45 am UTC.*094500+0100* for a period starting at 09:45 am local time, 1 hour ahead of UTC.*094500* for a period starting at 09:45 am local time, without specified offset to UTC.
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*tide relative to tide*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open interval (_minimum_ < _*underlying layer*_≤ _maximum_)
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*value of annual change in magnetic variation*_ _≤ maximum_)
...
[underline]#Range closure:# Open interval (_minimum <_ _*value of depth contour*_ _< maximum_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*value of magnetic variation*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*value of maximum range*_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*value of nominal range*_ _≤ maximum_)
...
[underline]#Range closure:# Open interval (_minimum <_ _*value of sounding*_ _< maximum_)Examples:*18.2* for a sounding of 18∙2 metres**-2.4** for a drying height of 2∙4 metres
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*vertical clearance value*_)
...
[underline]#Range closure:# Left half-open interval (_minimum <_ _*vertical length*_ _≤ maximum_)Minimum value: 0
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*waterway distance*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*wave length value*_)
...
[underline]#Range closure:# Left closed ray (_minimum ≤_ _*drawing index*_)
...
[underline]#Range closure:# Left closed ray (_minimum ≤_ _*horizontal distance uncertainty*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*line spacing maximum*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*line spacing minimum*_)
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*maximum display scale*_ _≤ maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*measurement distance maximum*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*measurement distance minimum*_)
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*minimum display scale*_ _≤ maximum_)
...
[underline]#Range closure:# Closed interval (_minimum ≤_ _*optimum display scale*_ _≤ maximum_)
...
[underline]#Range closure:# Right half-open interval (_minimum ≤_ _*orientation uncertainty*_ _< maximum_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*scale value maximum*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*scale value minimum*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*size of features detected*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*update number*_)
...
[underline]#Range closure:# Left half-open ray (_minimum <_ _*uncertainty fixed*_)
...
[underline]#Range closure:# Open interval (_minimum <_ _*default clearance depth*_ _< maximum_)Examples:*12.5* for a default clearance depth of 12.5 metres**-2.4** for a drying default clearance height of 2∙4 metres
...
[underline]#Range closure:# Open interval (_minimum <_ _*surrounding depth*_ _< maximum_)
