...
2+| 3+|
1: default name display +
2: alternate name display | (S) EN | 0,1 footnoteblock:[]
...
7: temporary | EN | 0,1
3+| scale minimum 2+| (SCAMIN) 3+| See <<sec_2.5.9>> | IN | 0,1
3+| information 2+| 3+| See <<sec_2.4.6>> | C | 0,\* footnoteblock:[]
...
3+| pictorial representation 2+| (PICREP) 3+| See <<sec_2.4.12.2>> | TE | 0,1 footnoteblock:[]
10+h| Feature Associations
h| S-101 Role 3+h| Association Type 3+h| Associated to 2+h| Type h| Multiplicity
...
2+| (SIGGRP)
3+| | (S) TE
| 0,\* (ordered) footnote:nineteen_two[For non-fixed lights (that is, sub-attribute *light characteristic* ≠ _1_ (fixed)), the sub-attributes *signal group* and *signal period* are mandatory.]

3+| signal period 2+| (SIGPER) 3+| | (S) RE | 0,1 footnote:nineteen_two[]
...
6: border stripe | EN | 0,1 footnoteblock:[]
3+| feature name 2+| 3+| See <<sec_2.5.8>> | C | 0,*
...
4: squared +
5: stripes (direction unknown)
6: border stripe | (S) EN | 0,1 footnoteblock:[]
...
4: approximate | EN | 0,1 footnoteblock:[]
3+| spatial accuracy
2+| 3+| | C | 0,\* footnoteblock:[]
...
10+| footnoteblock:[]At least one of the attributes *quality of horizontal measurement* or *spatial accuracy* must be encoded.
...
3+| feature name 2+| 3+| See <<sec_2.5.8>> | C | 0,\* footnoteblock:[]
