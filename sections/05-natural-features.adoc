...
| - 3+| *Spatial Association* (see clause 25.15) 3+| *Spatial Quality* 2+| Association | 0,*
10+.<| ^†^ At least one of the attributes *category of land region* or *feature name* must be populated.
...
Distinction: Land Area; Sea Area/Named Water Area; Slope Topline; Sloping Ground; Vegetation.
...
Distinction: Land Elevation; Slope Topline.

[[sec_5.15]]
=== Slope topline

[cols="560,799,799,799,799,799,799,799,294,553"]
|===
