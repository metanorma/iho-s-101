...
[cols="192,102,64,158,158,386,351,351,84,154"]
|===
...
9+.<| ^†^ Complex attribute **feature name**, sub-attribute *name usage* is mandatory if the name is intended to be displayed when display of names is enabled by the Mariner. See clause 2.5.8.
...
__**Figure 11-1 -- Swept areas -- Quality of bathymetric data**__
...
__**Figure 11-2 -- Depth contours**__
...
__**Figure 11-3 -- Geometry of depth areas**__
...
[cols="693,847,847,847,847,847,847,847,847,847,684"]
|===
...
11+.<| ^†^ For each instance of **information**, at least one of the sub-attributes *file reference* or *text* must be populated.
