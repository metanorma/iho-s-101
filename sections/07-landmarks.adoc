...
10+.<| ^†^ The attribute *colour pattern* is mandatory for landmarks that have more than one value populated for the attribute *colour*.
...
| - 3+| *Spatial Association* (see clause 25.15) 3+| *Spatial Quality* 2+| Association | 0,*
10+.<| ^†^ The attribute *colour pattern* is mandatory for silos or tanks that have more than one value populated for the attribute *colour*.
...
| - 3+| *Additional Information* (see clause 25.1) 3+| **Contact Details**, *Nautical Information* 2+| Association | 0,*
| - 3+| *Spatial Association* (see clause 25.15) 3+| *Spatial Quality* 2+| Association | 0,*
10+.<| ^†^ The attribute *colour pattern* is mandatory for bridges that have more than one value populated for the attribute *colour*.
