...
[cols="705,597,597,470,245,597,597,597,210,385"]
|===
...
Tidal stream values encoded in this way should be spring rates; that is, the tidal stream rates associated with a tidal range which is defined as the difference in height between MHWS and MLWS. Remarks:
...
__**Table 10-1 -- Tide Stream Panel Data - Example**__
